...
def get_socrates_ie_data():
  ...
  och_request = f"""<SiebelMessage>
            <SystemId>{out['specsaver_store_all']['ie_store_no']}</SystemId>
...
def get_consent_ie_data():
    socates_och_consent_request = [
                ...
                },
                {
                    ...
                    "store_number": out['specsaver_store_all']['ie_store_no'],
                    ...
                    "county": out['contrywise_address']['ROI_address']['county'],
                    "country": out['contrywise_address']['ROI_address']['country'],
                    "city": out['contrywise_address']['ROI_address']['city'],
                    "district": out['contrywise_address']['ROI_address']['county'],
                    "mobile": out['contrywise_random_phoneno']['ie_mobile_number'],
                    "home_phone": out['contrywise_random_phoneno']['ie_homephone_number'],
                    "work_phone": out['contrywise_random_phoneno']['ie_homephone_number'],
                    "email": out['email_random']['email_random_format1'],
                    "address_line_1": out['contrywise_address']['ROI_address']['addressline1'],
                    "postcode": out['contrywise_address']['ROI_address']['postcode']
                }
                    ] 
    return JSONResponse(content=socates_och_consent_request)

def get_merged_sycle_ie_data():
    unique_external_id = 331 * random.randint(1000, 12999)
    ...
    sycle_ie_request = f"""<ListOfSiebelMessages>
          <SiebelMessage>
    ...
    return Response(content=sycle_ie_request, media_type="application/xml")

def get_mergedconsent_sycle_ie_data():
