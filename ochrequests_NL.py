...
def get_socrates_nl_data():
  ...
  och_request = f"""<SiebelMessage>
            <SystemId>{out['specsaver_store_all']['nl_store_no']}</SystemId>
                ...
                <Contact>
                    ...
                    <ListOfPostalAddress>
                        <PostalAddress>
                            ...
                            <StreetAddressLine1>{out['contrywise_address']['NL_address']['addressline1']}</StreetAddressLine1>
                        <!---   <StreetAddressLine2>1 Blackness Avenue</StreetAddressLine2> -->
                            <Town>{out['contrywise_address']['NL_address']['city']}</Town>
                        <!---   <District>Whitele Avenue</District> -->
                            <County>{out['contrywise_address']['NL_address']['county']}</County>
                            <Country>{out['contrywise_address']['NL_address']['country']}</Country>
                            <Postcode>{out['contrywise_address']['NL_address']['postcode']}</Postcode>
                        </PostalAddress>
                    </ListOfPostalAddress>
                    <ListOfCommunicationAddress>
                        <CommunicationAddress>
                          ...
                          <Address>{out['contrywise_random_phoneno']['nl_homephone_number']}</Address>
                        ...
                        <CommunicationAddress>
                          ...
                          <Address>{out['contrywise_random_phoneno']['nl_mobile_number']}</Address>
                          <ActiveFlag>Y</ActiveFlag>
                        </CommunicationAddress>
                        <CommunicationAddress>
...
def get_consent_nl_data():
    socates_och_consent_request = [
                ...
                },
                {
                    ...
                    "store_number": out['specsaver_store_all']['nl_store_no'],
                    ...
                    "gender": out['personal']['random_gender']['nl_gender'],
                    "county": out['contrywise_address']['NL_address']['county'],
                    "country": out['contrywise_address']['NL_address']['country'],
                    "city": out['contrywise_address']['NL_address']['city'],
                    "district": out['contrywise_address']['NL_address']['county'],
                    "mobile": out['contrywise_random_phoneno']['nl_mobile_number'],
                    "home_phone": out['contrywise_random_phoneno']['nl_homephone_number'],
                    "work_phone": out['contrywise_random_phoneno']['nl_homephone_number'],
                    "email": out['email_random']['email_random_format1'],
                    "address_line_1": out['contrywise_address']['NL_address']['addressline1'],
                    "postcode": out['contrywise_address']['NL_address']['postcode']
                }
                    ] 
